...
export interface IStorage {
  ...
  // User Invites
  getUserInvite(id: string): Promise<UserInvite | undefined>;
  ...
  updateUserInviteEmailStatus(inviteId: string, status: string, sentAt?: Date): Promise<void>;
  updateUserInviteToken(inviteId: string, tokenHash: string, expiresAt: Date): Promise<void>;
  ...
  getConversationsByTenant(tenantId: string, options?: { limit?: number; offset?: number }): Promise<ConversationWithCustomer[]>;
  searchConversations(tenantId: string, query: string): Promise<ConversationWithCustomer[]>;
